...
3. Install system tools used by OCR/transcription:
...
1. Upload lecture file from the website.
2. Pipeline auto-detects source type (text, PDF, image, audio, video).
3. Content extraction is applied:
- PDF text extraction
- OCR for images/slides
- Audio transcription
- Video audio + keyframe OCR
4. AI/NLP summarization generates concise notes and key points.
5. Summary is exported as a downloadable PDF.
